                                ...
                                <div className="flex justify-between items-start">
                                    <div className="flex items-center">
                                        <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center text-2xl text-blue-800 font-semibold">
                                            {selectedCustomer?.name
                                                ...
                                                : 'N/A'} {/* Show initials or N/A */}
                                        </div>
                                        <div className="ml-4">
                                            <h2 className="text-2xl font-semibold text-gray-800">
                                                {selectedCustomer?.name ?? 'No customer selected'} {/* Fallback name */}
                                            </h2>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        ...
                                        <p className="font-medium">
                                            {selectedCustomer?.accountManager ?? 'N/A'} {/* Fallback account manager */}
                                        </p>
                                        <p className="text-sm text-gray-500 mt-1">Last Contact</p>
                                        <p className="font-medium">
                                            {selectedCustomer?.lastContact ?? 'N/A'} {/* Fallback last contact */}
                                        </p>
                                    </div>
                                </div>
                            </div>
