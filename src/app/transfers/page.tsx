...
import { Bell, Menu, Search, User, CreditCard, ArrowDownRight, ArrowUpRight, PieChart, Clock, ChevronDown, Repeat, Users, Globe } from 'lucide-react';
        ...
        <header className="bg-white border-b border-gray-200 p-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              ...
              <h2 className="text-xl font-semibold hidden md:block">Transfers</h2>
            </div>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      ...
                      {transferType === 'someone' && (
                        <select className="block w-full p-3 bg-gray-50 border border-gray-300 rounded-lg appearance-none pr-10">
